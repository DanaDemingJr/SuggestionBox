...
namespace SuggestionBox.Controllers
{
    public class SuggestionModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RecordNum,Name,Address")] SuggestionModel suggestionModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RecordNum,Name,Address")] SuggestionModel suggestionModel)
        {
            if (ModelState.IsValid)
            {
